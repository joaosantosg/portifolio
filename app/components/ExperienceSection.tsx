const ExperienceSection = () => {
    const experiences = [
        ...
        },
        {
            ...
            period: '2021 - Present',
            highlights: 'Desenvolvimento de soluções personalizadas para diversos clientes, focando em APIs RESTful com Spring Boot, automação de processos e arquiteturas escaláveis. Experiência direta com levantamento de requisitos e entrega de ponta a ponta.',
            status: 'current'
        },
        {
    ...
    return (
        <div className="min-h-full flex justify-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-300 text-lg">
                            Minha trajetória como engenheiro de software, destacando papéis, responsabilidades e conquistas.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-white/10">
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                            <div className="text-center">
                                ...
                                <div className="text-xs text-slate-400 uppercase tracking-wide">Anos de Experiência</div>
                            </div>
                            <div className="text-center">
                                <div className="text-3xl font-bold text-white mb-1">{experiences.length}</div>
                                <div className="text-xs text-slate-400 uppercase tracking-wide">Contextos</div>
                            </div>
                            <div className="text-center">
